...
> Walk me through Homework 3 in `homework/module-1/hw3.md` as an interactive tutorial. Read `AGENTS.md`, `homework/module-1/AGENTS.md`, the handout, `SPEC.md`, and `scenarios/skill/SKILL.md` first. I  have a programming background, so assume mild proficiency, and adapt once you see what I do know.
>
